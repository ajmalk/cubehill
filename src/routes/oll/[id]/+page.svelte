<script lang="ts">
   ...
   * OLL detail page.
   *
   * Shows the 3D cube loaded with the OLL case algorithm, playback controls,
...
<svelte:head>
  <title>{algorithm.name} — OLL — CubeHill</title>
  <meta
    name="description"
